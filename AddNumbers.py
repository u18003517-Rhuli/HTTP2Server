...
#if form:
#    if "profilePicture" in form:
#        form_file = form["profilePicture"]
#        if form_file.file:
#            fn = os.path.basename(form_file.filename)
#           #open('ServerData/' + fn, 'wb').write(form_file.file.read())
...
print("\t\t<form action='addNumber.py' method='post' enctype='multipart/form-data'>\n")
...
print("\t\t\t<input type='submit' id='submitButton' disabled value='Add' >\n")
print("\t\t</form>\n")
