...
print("\t\t\t\t<tr>\n")
print("\t\t\t\t\t<td>\n")
print("\t\t\t\t\t\t<input type='text' id ='Values' size='16' disabled=true value ='First Number'>\n")
print("\t\t\t\t\t</td>\n")
print("\t\t\t\t</tr>\n")
print("\t\t\t\t<tr>\n")
print("\t\t\t\t\t<td>\n")
print("\t\t\t\t\t\t<input type='text' id ='Answer' disabled=true value ='' >\n")
print("\t\t\t\t\t</td>\n")
print("\t\t\t\t</tr>\n")
print("\t\t\t\t<tr>\n")
print("\t\t\t\t\t<td>\n")
...
print("\t\t<form action='index.py' method='post'>\n")
print("\t\t\t<input type='text' id='calValue' name='calValue' >\n")
print("\t\t\t<input type='submit' value='log' >\n")
print("\t\t</form>\n")



print("\t\t</br>\n")
print("\t\t<img src='ServerData/catie.png' alt='Picture here'>\n")
